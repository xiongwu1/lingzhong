...
<link rel="stylesheet" href="${ctx }/resources/zyupload/skins/zyupload-1.0.0.min.css " type="text/css">
<script type="text/javascript" src="${ctx }/resources/zyupload/zyupload.tailor-1.0.0.min.js"></script>
<div class="home_content">
	<div class="left_menu">
		<div class="menu_url"><a href="${ctx }/home/home.do" target="main">首页</a></div>
		<div class="menu_url"><a href="${ctx }/home/myAttentLwList.do" target="main">收藏</a></div>
		<div class="menu_url"><a href="javascript:void();">赞</a></div>
		<div class="menu_url"><a href="javascript:void();">好友圈</a></div>
		<div class="menu_url"><a href="javascript:void();">我的邻文</a></div>
		<div class=""></div>
	</div>
<%-- 	<iframe src="${ctx }/home/home.do" name="main" width="auto" height="auto" frameborder="no" scrolling="no"></iframe> --%>
		...
		<div class="head_img">
			...
			<div>
				...
				<c:when test="${CURRENT_USER.headPortrait != null}">
					<a href="${ctx }/home/personalCenter.do"><img src="http://192.168.1.110:8888/${CURRENT_USER.headPortrait }" /></a>
				</c:when>
				<c:otherwise>
...
<script type="text/javascript">
	...
	Util.Load('home').wait(function(){
		Home.HomeIndex.HomeIndexLoad();
	});
</script>
